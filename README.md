...
Gladiator (short for Glimmer Editor) is a sample project under on-going development to demonstrate how to build a text editor with the [Glimmer](https://github.com/AndyObtiva/glimmer) Ruby Desktop Development GUI Library.

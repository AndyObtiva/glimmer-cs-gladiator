...
# -*- encoding: utf-8 -*-
# stub: glimmer-cs-gladiator 0.5.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<glimmer-dsl-swt>.freeze, [">= 4.17.8.1", "< 5.0.0.0"])
    ...
    s.add_dependency(%q<glimmer-dsl-swt>.freeze, [">= 4.17.8.1", "< 5.0.0.0"])

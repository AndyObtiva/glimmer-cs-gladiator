...
# -*- encoding: utf-8 -*-
# stub: glimmer-cs-gladiator 0.7.4 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.files = [
    ...
    "lib/views/glimmer/gladiator/splash.rb",
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<glimmer-dsl-swt>.freeze, [">= 4.18.2.0", "< 5.0.0.0"])
      ...
      s.add_dependency(%q<glimmer-dsl-swt>.freeze, [">= 4.18.2.0", "< 5.0.0.0"])
